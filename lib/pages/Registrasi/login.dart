...
import '../../firebase/registerGoogle.dart';
...
class _LoginState extends State<Login> {
  Future<void> _signInWithGoogle() async {
    try {
      ...
      // Navigate to register detail page
      Navigator.push(
        context,
        MaterialPageRoute(
          builder:
              (_) => RegisterGooglePage(
                email: user.email ?? '',
              ...
              SizedBox(
                ...
                child: DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Dengan melanjutkan, Anda sudah menyetujui Syarat dan Ketentuan serta Kebijakan Privasi yang berlaku',
                      style: TextStyle(
